...
class TestBorrow:
    ...
    def test_method_get_overview(self, client: NeptuneAPIV2) -> None:
        borrow = client.markets.borrow.get_overview()
        assert_matches_type(BorrowGetOverviewResponse, borrow, path=["response"])
    ...
    def test_raw_response_get_overview(self, client: NeptuneAPIV2) -> None:
        response = client.markets.borrow.with_raw_response.get_overview()
    ...
    def test_streaming_response_get_overview(self, client: NeptuneAPIV2) -> None:
        with client.markets.borrow.with_streaming_response.get_overview() as response:
    ...
    def test_method_get_rate_history(self, client: NeptuneAPIV2) -> None:
        borrow = client.markets.borrow.get_rate_history(
            end=0,
            period="h",
            start=0,
        )
    ...
    def test_raw_response_get_rate_history(self, client: NeptuneAPIV2) -> None:
        response = client.markets.borrow.with_raw_response.get_rate_history(
            end=0,
            period="h",
            start=0,
        )
    ...
    def test_streaming_response_get_rate_history(self, client: NeptuneAPIV2) -> None:
        with client.markets.borrow.with_streaming_response.get_rate_history(
            end=0,
            period="h",
            start=0,
        ) as response:
...
class TestAsyncBorrow:
    ...
    async def test_method_get_overview(self, async_client: AsyncNeptuneAPIV2) -> None:
        borrow = await async_client.markets.borrow.get_overview()
        assert_matches_type(BorrowGetOverviewResponse, borrow, path=["response"])
    ...
    async def test_raw_response_get_overview(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.markets.borrow.with_raw_response.get_overview()
    ...
    async def test_streaming_response_get_overview(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.markets.borrow.with_streaming_response.get_overview() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_rate_history(self, async_client: AsyncNeptuneAPIV2) -> None:
        borrow = await async_client.markets.borrow.get_rate_history(
            end=0,
            period="h",
            start=0,
        )
    ...
    async def test_raw_response_get_rate_history(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.markets.borrow.with_raw_response.get_rate_history(
            end=0,
            period="h",
            start=0,
        )
    ...
    async def test_streaming_response_get_rate_history(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.markets.borrow.with_streaming_response.get_rate_history(
            end=0,
            period="h",
            start=0,
        ) as response:
