...
class TestDebts:
    ...
    def test_method_list(self, client: NeptuneAPIV2) -> None:
        debt = client.markets.borrow.debts.list()
    ...
    def test_raw_response_list(self, client: NeptuneAPIV2) -> None:
        response = client.markets.borrow.debts.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: NeptuneAPIV2) -> None:
        with client.markets.borrow.debts.with_streaming_response.list() as response:
    ...
    def test_method_get_by_asset(self, client: NeptuneAPIV2) -> None:
        debt = client.markets.borrow.debts.get_by_asset(
            asset_id="token;-K-//-//3-",
        )
        assert_matches_type(DebtGetByAssetResponse, debt, path=["response"])
    ...
    def test_raw_response_get_by_asset(self, client: NeptuneAPIV2) -> None:
        response = client.markets.borrow.debts.with_raw_response.get_by_asset(
            asset_id="token;-K-//-//3-",
        )
    ...
    def test_streaming_response_get_by_asset(self, client: NeptuneAPIV2) -> None:
        with client.markets.borrow.debts.with_streaming_response.get_by_asset(
            asset_id="token;-K-//-//3-",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncDebts:
    ...
    async def test_method_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        debt = await async_client.markets.borrow.debts.list()
        assert_matches_type(DebtListResponse, debt, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.markets.borrow.debts.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.markets.borrow.debts.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_by_asset(self, async_client: AsyncNeptuneAPIV2) -> None:
        debt = await async_client.markets.borrow.debts.get_by_asset(
            asset_id="token;-K-//-//3-",
        )
        assert_matches_type(DebtGetByAssetResponse, debt, path=["response"])
    ...
    async def test_raw_response_get_by_asset(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.markets.borrow.debts.with_raw_response.get_by_asset(
            asset_id="token;-K-//-//3-",
        )
    ...
    async def test_streaming_response_get_by_asset(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.markets.borrow.debts.with_streaming_response.get_by_asset(
            asset_id="token;-K-//-//3-",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
