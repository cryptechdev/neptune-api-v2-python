...
class TestPools:
    ...
    def test_method_list(self, client: NeptuneAPIV2) -> None:
        pool = client.v1.users.nept.staking.pools.list(
            address="address",
        )
    ...
    def test_raw_response_list(self, client: NeptuneAPIV2) -> None:
        response = client.v1.users.nept.staking.pools.with_raw_response.list(
            address="address",
        )
    ...
    def test_streaming_response_list(self, client: NeptuneAPIV2) -> None:
        with client.v1.users.nept.staking.pools.with_streaming_response.list(
            address="address",
        ) as response:
    ...
    def test_path_params_list(self, client: NeptuneAPIV2) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            client.v1.users.nept.staking.pools.with_raw_response.list(
                address="",
            )
    ...
    def test_method_retrieve_lookup(self, client: NeptuneAPIV2) -> None:
        pool = client.v1.users.nept.staking.pools.retrieve_lookup(
            address="address",
        )
        assert_matches_type(PoolRetrieveLookupResponse, pool, path=["response"])
    ...
    def test_raw_response_retrieve_lookup(self, client: NeptuneAPIV2) -> None:
        response = client.v1.users.nept.staking.pools.with_raw_response.retrieve_lookup(
            address="address",
        )
    ...
    def test_streaming_response_retrieve_lookup(self, client: NeptuneAPIV2) -> None:
        with client.v1.users.nept.staking.pools.with_streaming_response.retrieve_lookup(
            address="address",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve_lookup(self, client: NeptuneAPIV2) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            client.v1.users.nept.staking.pools.with_raw_response.retrieve_lookup(
                address="",
            )
...
class TestAsyncPools:
    ...
    async def test_method_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        pool = await async_client.v1.users.nept.staking.pools.list(
            address="address",
        )
        assert_matches_type(PoolListResponse, pool, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.users.nept.staking.pools.with_raw_response.list(
            address="address",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.users.nept.staking.pools.with_streaming_response.list(
            address="address",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            await async_client.v1.users.nept.staking.pools.with_raw_response.list(
                address="",
            )
    ...
    async def test_method_retrieve_lookup(self, async_client: AsyncNeptuneAPIV2) -> None:
        pool = await async_client.v1.users.nept.staking.pools.retrieve_lookup(
            address="address",
        )
        assert_matches_type(PoolRetrieveLookupResponse, pool, path=["response"])
    ...
    async def test_raw_response_retrieve_lookup(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.users.nept.staking.pools.with_raw_response.retrieve_lookup(
            address="address",
        )
    ...
    async def test_streaming_response_retrieve_lookup(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.users.nept.staking.pools.with_streaming_response.retrieve_lookup(
            address="address",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_lookup(self, async_client: AsyncNeptuneAPIV2) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            await async_client.v1.users.nept.staking.pools.with_raw_response.retrieve_lookup(
                address="",
            )
