...
class TestLend:
    ...
    def test_method_list(self, client: NeptuneAPIV2) -> None:
        lend = client.v1.users.markets.lend.list(
            address="address",
        )
    ...
    def test_raw_response_list(self, client: NeptuneAPIV2) -> None:
        response = client.v1.users.markets.lend.with_raw_response.list(
            address="address",
        )
    ...
    def test_streaming_response_list(self, client: NeptuneAPIV2) -> None:
        with client.v1.users.markets.lend.with_streaming_response.list(
            address="address",
        ) as response:
    ...
    def test_path_params_list(self, client: NeptuneAPIV2) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            client.v1.users.markets.lend.with_raw_response.list(
                address="",
            )
    ...
    def test_method_retrieve_lookup(self, client: NeptuneAPIV2) -> None:
        lend = client.v1.users.markets.lend.retrieve_lookup(
            address="address",
            asset_id="token;-K-//-//3-",
        )
        assert_matches_type(LendRetrieveLookupResponse, lend, path=["response"])
    ...
    def test_raw_response_retrieve_lookup(self, client: NeptuneAPIV2) -> None:
        response = client.v1.users.markets.lend.with_raw_response.retrieve_lookup(
            address="address",
            asset_id="token;-K-//-//3-",
        )
    ...
    def test_streaming_response_retrieve_lookup(self, client: NeptuneAPIV2) -> None:
        with client.v1.users.markets.lend.with_streaming_response.retrieve_lookup(
            address="address",
            asset_id="token;-K-//-//3-",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve_lookup(self, client: NeptuneAPIV2) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            client.v1.users.markets.lend.with_raw_response.retrieve_lookup(
                address="",
                asset_id="token;-K-//-//3-",
            )
...
class TestAsyncLend:
    ...
    async def test_method_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        lend = await async_client.v1.users.markets.lend.list(
            address="address",
        )
        assert_matches_type(LendListResponse, lend, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.users.markets.lend.with_raw_response.list(
            address="address",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.users.markets.lend.with_streaming_response.list(
            address="address",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            await async_client.v1.users.markets.lend.with_raw_response.list(
                address="",
            )
    ...
    async def test_method_retrieve_lookup(self, async_client: AsyncNeptuneAPIV2) -> None:
        lend = await async_client.v1.users.markets.lend.retrieve_lookup(
            address="address",
            asset_id="token;-K-//-//3-",
        )
        assert_matches_type(LendRetrieveLookupResponse, lend, path=["response"])
    ...
    async def test_raw_response_retrieve_lookup(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.users.markets.lend.with_raw_response.retrieve_lookup(
            address="address",
            asset_id="token;-K-//-//3-",
        )
    ...
    async def test_streaming_response_retrieve_lookup(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.users.markets.lend.with_streaming_response.retrieve_lookup(
            address="address",
            asset_id="token;-K-//-//3-",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve_lookup(self, async_client: AsyncNeptuneAPIV2) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            await async_client.v1.users.markets.lend.with_raw_response.retrieve_lookup(
                address="",
                asset_id="token;-K-//-//3-",
            )
