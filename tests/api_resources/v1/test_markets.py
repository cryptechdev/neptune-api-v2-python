...
class TestMarkets:
    ...
    def test_method_overview(self, client: NeptuneAPIV2) -> None:
        market = client.v1.markets.overview()
        assert_matches_type(MarketOverviewResponse, market, path=["response"])
    ...
    def test_raw_response_overview(self, client: NeptuneAPIV2) -> None:
        response = client.v1.markets.with_raw_response.overview()
    ...
    def test_streaming_response_overview(self, client: NeptuneAPIV2) -> None:
        with client.v1.markets.with_streaming_response.overview() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncMarkets:
    ...
    async def test_method_overview(self, async_client: AsyncNeptuneAPIV2) -> None:
        market = await async_client.v1.markets.overview()
        assert_matches_type(MarketOverviewResponse, market, path=["response"])
    ...
    async def test_raw_response_overview(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.markets.with_raw_response.overview()
    ...
    async def test_streaming_response_overview(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.markets.with_streaming_response.overview() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
