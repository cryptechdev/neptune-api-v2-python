...
class TestNept:
    ...
    def test_method_get_params(self, client: NeptuneAPIV2) -> None:
        nept = client.v1.nept.get_params()
    ...
    def test_raw_response_get_params(self, client: NeptuneAPIV2) -> None:
        response = client.v1.nept.with_raw_response.get_params()
    ...
    def test_streaming_response_get_params(self, client: NeptuneAPIV2) -> None:
        with client.v1.nept.with_streaming_response.get_params() as response:
    ...
    def test_raw_response_get_state(self, client: NeptuneAPIV2) -> None:
        response = client.v1.nept.with_raw_response.get_state()
    ...
    def test_streaming_response_get_state(self, client: NeptuneAPIV2) -> None:
        with client.v1.nept.with_streaming_response.get_state() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncNept:
    ...
    async def test_method_get_params(self, async_client: AsyncNeptuneAPIV2) -> None:
        nept = await async_client.v1.nept.get_params()
        assert_matches_type(NeptGetParamsResponse, nept, path=["response"])
    ...
    async def test_raw_response_get_params(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.nept.with_raw_response.get_params()
    ...
    async def test_streaming_response_get_params(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.nept.with_streaming_response.get_params() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_state(self, async_client: AsyncNeptuneAPIV2) -> None:
        nept = await async_client.v1.nept.get_state()
        assert_matches_type(NeptGetStateResponse, nept, path=["response"])
    ...
    async def test_raw_response_get_state(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.nept.with_raw_response.get_state()
    ...
    async def test_streaming_response_get_state(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.nept.with_streaming_response.get_state() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
