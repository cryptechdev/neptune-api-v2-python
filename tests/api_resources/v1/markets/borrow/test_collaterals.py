...
class TestCollaterals:
    ...
    def test_method_list(self, client: NeptuneAPIV2) -> None:
        collateral = client.v1.markets.borrow.collaterals.list()
    ...
    def test_raw_response_list(self, client: NeptuneAPIV2) -> None:
        response = client.v1.markets.borrow.collaterals.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: NeptuneAPIV2) -> None:
        with client.v1.markets.borrow.collaterals.with_streaming_response.list() as response:
    ...
    def test_method_lookup_by_asset(self, client: NeptuneAPIV2) -> None:
        collateral = client.v1.markets.borrow.collaterals.lookup_by_asset(
            asset_id="token;-K-//-//3-",
        )
        assert_matches_type(CollateralLookupByAssetResponse, collateral, path=["response"])
    ...
    def test_raw_response_lookup_by_asset(self, client: NeptuneAPIV2) -> None:
        response = client.v1.markets.borrow.collaterals.with_raw_response.lookup_by_asset(
            asset_id="token;-K-//-//3-",
        )
    ...
    def test_streaming_response_lookup_by_asset(self, client: NeptuneAPIV2) -> None:
        with client.v1.markets.borrow.collaterals.with_streaming_response.lookup_by_asset(
            asset_id="token;-K-//-//3-",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncCollaterals:
    ...
    async def test_method_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        collateral = await async_client.v1.markets.borrow.collaterals.list()
        assert_matches_type(CollateralListResponse, collateral, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.markets.borrow.collaterals.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.markets.borrow.collaterals.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_lookup_by_asset(self, async_client: AsyncNeptuneAPIV2) -> None:
        collateral = await async_client.v1.markets.borrow.collaterals.lookup_by_asset(
            asset_id="token;-K-//-//3-",
        )
        assert_matches_type(CollateralLookupByAssetResponse, collateral, path=["response"])
    ...
    async def test_raw_response_lookup_by_asset(self, async_client: AsyncNeptuneAPIV2) -> None:
        response = await async_client.v1.markets.borrow.collaterals.with_raw_response.lookup_by_asset(
            asset_id="token;-K-//-//3-",
        )
    ...
    async def test_streaming_response_lookup_by_asset(self, async_client: AsyncNeptuneAPIV2) -> None:
        async with async_client.v1.markets.borrow.collaterals.with_streaming_response.lookup_by_asset(
            asset_id="token;-K-//-//3-",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
