...
from neptune_api_v2 import NeptuneAPIV2, AsyncNeptuneAPIV2, APIResponseValidationError
from neptune_api_v2._types import Omit
from neptune_api_v2._utils import asyncify
from neptune_api_v2._models import BaseModel, FinalRequestOptions
from neptune_api_v2._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from neptune_api_v2._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: NeptuneAPIV2 | AsyncNeptuneAPIV2) -> int:
...
class TestNeptuneApiv2:
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
    ...
    def test_copy(self, client: NeptuneAPIV2) -> None:
        copied = client.copy()
    ...
    def test_copy_signature(self, client: NeptuneAPIV2) -> None:
    ...
    def test_copy_build_request(self, client: NeptuneAPIV2) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "neptune_api_v2/_legacy_response.py",
                        "neptune_api_v2/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "neptune_api_v2/_compat.py",
    ...
    def test_request_timeout(self, client: NeptuneAPIV2) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_request_extra_headers(self, client: NeptuneAPIV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: NeptuneAPIV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: NeptuneAPIV2) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
    ...
    def test_non_application_json_content_type_for_json_data(
        self, respx_mock: MockRouter, client: NeptuneAPIV2
    ) -> None:
        """
    ...
    def test_base_url_trailing_slash(self, client: NeptuneAPIV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: NeptuneAPIV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: NeptuneAPIV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: NeptuneAPIV2
    ) -> None:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.v1.status.with_streaming_response.check_health().__enter__()
    ...
    def test_omit_retry_count_header(
        self, client: NeptuneAPIV2, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.v1.status.with_raw_response.check_health(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.v1.status.with_raw_response.check_health(extra_headers={"x-stainless-retry-count": "42"})
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: NeptuneAPIV2) -> None:
...
class TestAsyncNeptuneApiv2:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncNeptuneAPIV2) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncNeptuneAPIV2) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncNeptuneAPIV2) -> None:
    ...
    def test_copy_signature(self, async_client: AsyncNeptuneAPIV2) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncNeptuneAPIV2) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncNeptuneAPIV2) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncNeptuneAPIV2) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncNeptuneAPIV2) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncNeptuneAPIV2) -> None:
        class Model1(BaseModel):
            name: str
    ...
    async def test_base_url_trailing_slash(self, client: AsyncNeptuneAPIV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncNeptuneAPIV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncNeptuneAPIV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncNeptuneAPIV2
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.v1.status.with_streaming_response.check_health().__aenter__()
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncNeptuneAPIV2,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.v1.status.with_raw_response.check_health()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncNeptuneAPIV2, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncNeptuneAPIV2) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncNeptuneAPIV2) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
