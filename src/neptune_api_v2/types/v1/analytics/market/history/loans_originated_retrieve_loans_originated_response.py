...
__all__ = ["LoansOriginatedRetrieveLoansOriginatedResponse", "Data", "DataPagination", "DataPoint", "DataRange"]
...
class LoansOriginatedRetrieveLoansOriginatedResponse(BaseModel):
    status: int
    """Request status"""
