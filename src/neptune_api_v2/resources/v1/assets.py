...
from ...types.v1 import IntervalUnit, asset_list_prices_params, asset_get_price_history_params
...
from ...types.v1.asset_list_response import AssetListResponse
from ...types.v1.asset_list_prices_response import AssetListPricesResponse
from ...types.v1.asset_get_price_history_response import AssetGetPriceHistoryResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"with_text": with_text}, asset_list_prices_params.AssetListPricesParams),
            ),
            cast_to=AssetListPricesResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"with_text": with_text}, asset_list_prices_params.AssetListPricesParams
                ),
            ),
            cast_to=AssetListPricesResponse,
        )
...
class AssetsResourceWithRawResponse:
    def __init__(self, assets: AssetsResource) -> None:
        ...
        self.get_price_history = to_raw_response_wrapper(
            assets.get_price_history,
        )
        self.list_prices = to_raw_response_wrapper(
            assets.list_prices,
        )
...
class AsyncAssetsResourceWithRawResponse:
    def __init__(self, assets: AsyncAssetsResource) -> None:
        ...
        self.get_price_history = async_to_raw_response_wrapper(
            assets.get_price_history,
        )
        self.list_prices = async_to_raw_response_wrapper(
            assets.list_prices,
        )
...
class AssetsResourceWithStreamingResponse:
    def __init__(self, assets: AssetsResource) -> None:
        ...
        self.get_price_history = to_streamed_response_wrapper(
            assets.get_price_history,
        )
        self.list_prices = to_streamed_response_wrapper(
            assets.list_prices,
        )
...
class AsyncAssetsResourceWithStreamingResponse:
    def __init__(self, assets: AsyncAssetsResource) -> None:
        ...
        self.get_price_history = async_to_streamed_response_wrapper(
            assets.get_price_history,
        )
        self.list_prices = async_to_streamed_response_wrapper(
            assets.list_prices,
        )
