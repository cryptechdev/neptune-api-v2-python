...
pip install git+ssh://git@github.com/stainless-sdks/neptune-api-v2-python.git
```
...
```sh
# install from this staging repo
pip install 'neptune_api_v2[aiohttp] @ git+ssh://git@github.com/stainless-sdks/neptune-api-v2-python.git'
```
...
The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/neptune-api-v2-python/tree/main/src/neptune_api_v2/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/neptune-api-v2-python/issues) with questions, bugs, or suggestions.
